...
color="info" variant="soft" icon="i-lucide-info" class="mb-4"
				...
				<UCard class="shadow-sm">
					<UAlert
						...
						title="Загружайте только документ с техническими параметрами"
						description="Перед загрузкой уберите из технического задания требования, не относящиеся к техническим (реквизиты, методику оценки заявок и иную нерелевантную информацию). Так проверка на соответствие с коммерческим предложением будет наиболее эффективна."
						class="mb-5"
					/>
