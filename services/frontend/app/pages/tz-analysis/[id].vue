...
color="info" variant="soft" icon="i-lucide-info" class="mb-4"
					description="Загрузите техническое задание и запустите анализ. После извлечения требований вы сможете проверить их и загрузить коммерческие предложения. Загружайте только разделы ТЗ, связанные с техническими параметрами оборудования — это снижает нагрузку на анализ и ускоряет обработку." />
