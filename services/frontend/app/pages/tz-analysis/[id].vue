...
color="info" variant="soft" icon="i-lucide-info" class="mb-4"
				...
				<UCard class="shadow-sm">
					<UAlert
						...
						title="Загружайте только нужную часть документа"
						description="Мы извлекаем из файла ВСЕ пункты с сохранением исходной нумерации — включая разделы, которые не являются техническими требованиями. Уберите из файла перед загрузкой юридические условия, реквизиты сторон, порядок обжалования, методику оценки заявок и другую административную информацию, не относящуюся к требованиям к товару/работам/услугам. Так список требований останется точным и не будет перегружен лишними пунктами."
						class="mb-5"
					/>
