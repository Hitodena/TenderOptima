...
export const HERO_TRUST_BADGES: HeroTrustBadge[] = [
	{ icon: 'i-lucide-mail', label: 'Запросы отправлены 12 компаниям' },
	{ icon: 'i-lucide-zap', label: 'Сравнение завершено за 7 минут' },
...
export const JTBD_BRIDGE_PANELS: JtbdBridgePanel[] = [
	...
	},
	{
		...
		metrics: [
			{ value: 'до 92%', label: 'точность сверки' },
...
export const CONTACT_SUPPORT = {
	title: 'Поддержка',
	lead:
		'Круглосуточный приём заявок. Поможем решить вопрос: пн–пт с 9:00 до 18:00.',
	emails: [
		{
...
export const FAQ_ITEMS: FaqItem[] = [
	...
	},
	{
		...
		answer: 'В разлеле история запросов отображаются «Входящие / Всего». Когда поступает новый ответ от поставщика вы сразу это увидите как новое сообщение в соответствующем запросе.',
	},
	{
		question: 'Насколько безопасно решение и где могут храниться данные?',
		answer: 'Данные хранятся в защищённом облаке или на серверах заказчика (по запросу). Данные обрабатываются в полном соответствии с законодательством Республики Беларусь и условиями пользовательского соглашения.',
	},
	{
...
export const ROI_PAYBACK_POINTS: RoiPaybackPoint[] = [
	{
		...
		title: 'Дожим по цене',
		description:
			'Эффективные механики снижения цены в один клик. Экономия на одном контракте часто превышает годовую подписку.',
	},
	{
		icon: 'i-lucide-shield-alert',
		title: 'Сверка ТЗ и КП',
		description:
			'Одна пропущенная несостыковка в оборудовании стоит дороже тарифа. Система подсказывает расхождения до подписания договора.',
	},
]
...
export const CASE_STUDIES: CaseStudy[] = [
	...
	},
	{
		...
		metric: 'точность сверки требований до 95%',
		description:
