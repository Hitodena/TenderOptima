...
цену единицы; для «Общая цена поставки» — итоговую сумму всей поставки \
по всем позициям заказа, а не цену единицы
...
«Общая стоимость без НДС», «Общая цена поставки», а также цена, стоимость, \
тариф, за шт, коп., \
