    ...
    async def update_fields(
        ...
        **values: Any,
        ...
        try:
            ...
            # Refresh only this row — expire_all() also expires other loaded
            # objects (e.g. current_user) and can raise MissingGreenlet later.
            updated = await session.get(cls.model, id)
